// test.c
// Test program for AES in OFB mode. 
...
int main(void) {
	...
	// run OFB mode twice, once for 'encryption' and again for 'decryption'
	aes_128_ofb_cipher(ct, pt, NBYTES, key, iv);
	aes_128_ofb_cipher(nt, ct, NBYTES, key, iv);
